...
select_core = (SELECT + Optional(DISTINCT | ALL) + Group(delimitedList(result_column))("columns") +
                ...
                Optional((AND + expr("and1_expr"))) + #and put here
                Optional((AND + expr("and2_expr"))) + #and put here
...
for t in tests:
    ...
    try:
        ...
        #sql_object_parse = select_stmt.parseString(t)
        #table_name = sql_object_parse.table[0]
